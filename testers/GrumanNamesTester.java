...
public class GrumanNamesTester
{
  ...
  public static void main(String[] args)
  {
    ...
    GrumanNames namesSingleton = GrumanNames.getInstance();
    ...
    System.out.println("Show that the old names that were replaced are gone");
